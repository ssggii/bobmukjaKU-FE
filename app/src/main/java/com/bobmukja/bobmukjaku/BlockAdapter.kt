...
import com.bobmukja.bobmukjaku.databinding.BlockListBinding
...
class BlockAdapter(var items: List<BlockInfoDto>, var onBlockRemovedListener: OnBlockRemovedListener): RecyclerView.Adapter<BlockAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: BlockAdapter.ViewHolder, @SuppressLint("RecyclerView") position: Int) {
        ...
        holder.binding.blockBtn.setOnClickListener {
            val dialogView = LayoutInflater.from(holder.binding.root.context).inflate(
                R.layout.block_delete_dialog, null)
